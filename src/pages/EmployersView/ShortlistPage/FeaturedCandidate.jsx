...
export default function FeaturedCandidate() {
  return (
    <div className="relative w-[calc(50%-20px)] mt-6 mb-6 break-words bg-white border shadow-xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
      <div className="pb-6">
        ...
        <div className="mt-2 mt-20 text-center">
          <h3 className="mb-1 text-lg font-bold leading-normal text-gray-700 dark:text-gray-300">
            Ariel Cerda
          </h3>
        ...
        <div className="pt-6 mx-2 mt-6 text-center border-t border-gray-200 dark:border-gray-700/50">
          <div className="flex flex-wrap justify-center">
            <div className="w-full px-6">
              <p className="mb-4 font-light leading-relaxed text-gray-600 dark:text-gray-400 text-sm text-left">
