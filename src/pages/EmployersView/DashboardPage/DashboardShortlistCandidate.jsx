...
export default function DashboardShortlistCandidate() {
  return (
    <div className="relative w-[calc(100%-10px)] group min-w-0 mx-1 mb-6 break-words bg-white border shadow-lg dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl mt-24">
      <div className="pb-6">
