...
export default function RecruiterRepresentative() {
  ...
  const recruiterEmail = 'eduardo@florianlaurent.com'
  const recruiterPhone = '+1 604 123 4567'
              ...
              <div className="flex items-center">
                <div className="flex flex-col">
                  <div className="flex space-between mb-3">
                    <div className="w-full flex-none text-lg font-bold text-gray-900 leading-none mb-2">
                      {recruiterName}
                    </div>
                  ...
                  <div className="flex px-1 text-gray-800 font-bold mb-1">
                    <Typography className="text-sm font-bold text-gray-800 mr-2">
                      {recruiterTitle}
                    </Typography>
                    <Typography className="text-sm font-bold text-gray-800 mr-2">
                      {' • '}
                  ...
                  <div className="flex text-gray-700 mb-2">
                    <Typography className="text-sm text-gray-900 mr-2">
                      <button
                    ...
                    <Typography className="text-sm text-gray-900 mr-2 py-1">
                      {' • '}
                    </Typography>
                    <Typography className="text-sm text-gray-900 mr-2">
                      <button
