...
export default function OrderStatusPage() {
  return (
    <div className="bg-white shadow-xl p-7 rounded-2xl container mx-auto my-6">
        ...
        <section id="left" className="w-1/2 px-4">
          <div className="mb-6">
            ...
            <p className="mb-6">
              ...
              Accusantium veritatis molestiae ut porro? Aperiam, unde quasi ex
              alias tempora, rem voluptatum, nam veritatis sit dolores ab
              deleniti sint. Quod, maiores!
            </p>
            <p className="mb-6">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Accusantium veritatis molestiae ut porro? Aperiam, unde quasi ex
