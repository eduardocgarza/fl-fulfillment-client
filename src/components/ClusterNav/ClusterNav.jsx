...
export default function ClusterNav() {
  ...
  const navList = (
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <Link to={rootNav}>Dashboard</Link>
      </Typography>
      {/* <Typography
        as="li"
        variant="small"
      ...
      <Typography
        ...
        className="p-1 font-normal"
      >
        <Link to={`${rootNav}/posting`}>Job Posting</Link>
      </Typography>
      <Typography
        as="li"
        variant="small"
        ...
        className="p-1 font-normal"
      >
        <Link to={`${rootNav}/candidates`}>Shortlist</Link>
      </Typography>
      <Typography
        as="li"
        variant="small"
        ...
        className="p-1 font-normal"
      >
        <Link to={`${rootNav}/settings`}>Settings</Link>
      </Typography>
    </ul>
  )
